...
BLOG_AUTHOR = "Oleg Pittman"  # (translatable)
BLOG_TITLE = "Oleg's Ramblings"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://amerikrainian.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://amerikrainian.com/"
BLOG_EMAIL = "olegjpittman@gmail.com"
BLOG_DESCRIPTION = "Thoughts, hopes, wishes... anything goes!"  # (translatable)
